...
public class MyStringList {
	...
	public static void main(String[] args){
		...
		if(l.search("number"))
			System.out.println("\nThe String number exist in the list");
		else
			System.out.println("\nThe String number doesn't exist in the list");
		
		if(l.search("tiny"))
			System.out.println("\nThe String tiny exist in the list");
		else
			System.out.println("\nThe String tiny doesn't exist in the list");
